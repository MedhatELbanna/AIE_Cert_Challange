...
- [Task 1: Problem, Audience, and Scope](#task-1-problem-audience-and-scope)
  ...
  - [Evaluation Questions and Input-Output Pairs](#evaluation-questions-and-input-output-pairs)
- [Task 2: Proposed Solution](#task-2-proposed-solution)
  - [Solution Description](#solution-description)
  - [Infrastructure Diagram](#infrastructure-diagram)
  - [Tooling Choices and Justifications](#tooling-choices-and-justifications)
...
- [Task 4: End-to-End Prototype](#task-4-end-to-end-prototype)
  - [Architecture — Deep Agent Pattern](#architecture--deep-agent-pattern)
  - [Structured Output Models](#structured-output-models)
  - [Streamlit UI](#streamlit-ui)
  - [Validated End-to-End Results](#validated-end-to-end-results)
- [Task 5: RAGAS Evaluation — Baseline Results](#task-5-ragas-evaluation--baseline-results)
  - [Synthetic Test Data Generation](#synthetic-test-data-generation)
  - [Evaluation Metrics](#evaluation-metrics)
  - [Baseline Results — Basic Pipeline](#baseline-results--basic-pipeline-dense-retrieval)
...
- [Task 6: Advanced Retrieval Technique and Comparison](#task-6-advanced-retrieval-technique-and-comparison)
  - [Technique: Hybrid BM25 + Dense with Parent-Child Retrieval](#technique-hybrid-bm25--dense-with-parent-child-retrieval)
  - [Implementation Details](#implementation-details)
  - [Fair Comparison Setup](#fair-comparison-setup)
  - [Aggregate Comparison Results](#aggregate-comparison-results)
  - [Per-Query-Type Comparison](#per-query-type-comparison)
  - [Analysis](#analysis)
- [Task 7: Next Steps](#task-7-next-steps)
  - [Decision: Keep the Advanced Retrieval Pipeline](#decision-keep-the-advanced-retrieval-pipeline)
